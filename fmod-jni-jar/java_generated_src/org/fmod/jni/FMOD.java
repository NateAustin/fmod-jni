...
public class FMOD implements FMODConstants {
  ...
  public static FMOD_RESULT FMOD_Studio_EventInstance_GetParameterValue(SWIGTYPE_p_FMOD_STUDIO_EVENTINSTANCE eventinstance, String name, float[] value) {
    return FMOD_RESULT.swigToEnum(FMODJNI.FMOD_Studio_EventInstance_GetParameterValue(SWIGTYPE_p_FMOD_STUDIO_EVENTINSTANCE.getCPtr(eventinstance), name, value));
  }
  ...
  public static FMOD_RESULT FMOD_Studio_EventInstance_GetParameterValueByIndex(SWIGTYPE_p_FMOD_STUDIO_EVENTINSTANCE eventinstance, int index, float[] value) {
    return FMOD_RESULT.swigToEnum(FMODJNI.FMOD_Studio_EventInstance_GetParameterValueByIndex(SWIGTYPE_p_FMOD_STUDIO_EVENTINSTANCE.getCPtr(eventinstance), index, value));
  }
