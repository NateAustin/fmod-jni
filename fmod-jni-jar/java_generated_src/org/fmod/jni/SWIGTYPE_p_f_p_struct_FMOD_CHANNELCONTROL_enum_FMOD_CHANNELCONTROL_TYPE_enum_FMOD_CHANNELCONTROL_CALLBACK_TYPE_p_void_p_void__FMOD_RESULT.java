...
public class SWIGTYPE_p_f_p_struct_FMOD_CHANNELCONTROL_enum_FMOD_CHANNELCONTROL_TYPE_enum_FMOD_CHANNELCONTROL_CALLBACK_TYPE_p_void_p_void__FMOD_RESULT {
  private transient long swigCPtr;

  protected SWIGTYPE_p_f_p_struct_FMOD_CHANNELCONTROL_enum_FMOD_CHANNELCONTROL_TYPE_enum_FMOD_CHANNELCONTROL_CALLBACK_TYPE_p_void_p_void__FMOD_RESULT(long cPtr, @SuppressWarnings("unused") boolean futureUse) {
    swigCPtr = cPtr;
  }

  protected SWIGTYPE_p_f_p_struct_FMOD_CHANNELCONTROL_enum_FMOD_CHANNELCONTROL_TYPE_enum_FMOD_CHANNELCONTROL_CALLBACK_TYPE_p_void_p_void__FMOD_RESULT() {
    swigCPtr = 0;
  }
