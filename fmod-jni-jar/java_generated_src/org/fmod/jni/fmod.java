...
public class fmod implements fmodConstants {
  ...
  public static FMOD_RESULT FMOD_System_GetChannelsPlaying(SWIGTYPE_p_FMOD_SYSTEM system, int[] channels) {
    return FMOD_RESULT.swigToEnum(fmodJNI.FMOD_System_GetChannelsPlaying(SWIGTYPE_p_FMOD_SYSTEM.getCPtr(system), channels));
  }
  ...
  public static FMOD_RESULT FMOD_Sound_SetSubSound(SWIGTYPE_p_FMOD_SOUND sound, int index, SWIGTYPE_p_FMOD_SOUND subsound) {
    return FMOD_RESULT.swigToEnum(fmodJNI.FMOD_Sound_SetSubSound(SWIGTYPE_p_FMOD_SOUND.getCPtr(sound), index, SWIGTYPE_p_FMOD_SOUND.getCPtr(subsound)));
  }
  ...
  public static FMOD_RESULT FMOD_Sound_ReadData(SWIGTYPE_p_FMOD_SOUND sound, SWIGTYPE_p_void buffer, long lenbytes, long[] read) {
    return FMOD_RESULT.swigToEnum(fmodJNI.FMOD_Sound_ReadData(SWIGTYPE_p_FMOD_SOUND.getCPtr(sound), SWIGTYPE_p_void.getCPtr(buffer), lenbytes, read));
  }
  ...
  public static FMOD_RESULT FMOD_Channel_OverridePanDSP(SWIGTYPE_p_FMOD_CHANNEL channel, SWIGTYPE_p_FMOD_DSP pan) {
    return FMOD_RESULT.swigToEnum(fmodJNI.FMOD_Channel_OverridePanDSP(SWIGTYPE_p_FMOD_CHANNEL.getCPtr(channel), SWIGTYPE_p_FMOD_DSP.getCPtr(pan)));
  }
  ...
  public static FMOD_RESULT FMOD_ChannelGroup_OverridePanDSP(SWIGTYPE_p_FMOD_CHANNELGROUP channelgroup, SWIGTYPE_p_FMOD_DSP pan) {
    return FMOD_RESULT.swigToEnum(fmodJNI.FMOD_ChannelGroup_OverridePanDSP(SWIGTYPE_p_FMOD_CHANNELGROUP.getCPtr(channelgroup), SWIGTYPE_p_FMOD_DSP.getCPtr(pan)));
  }
  ...
  public static FMOD_RESULT FMOD_Studio_EventInstance_GetVolume(SWIGTYPE_p_FMOD_STUDIO_EVENTINSTANCE eventinstance, float[] volume) {
    return FMOD_RESULT.swigToEnum(fmodJNI.FMOD_Studio_EventInstance_GetVolume(SWIGTYPE_p_FMOD_STUDIO_EVENTINSTANCE.getCPtr(eventinstance), volume));
  }
  ...
  public static FMOD_RESULT FMOD_Studio_EventInstance_GetPitch(SWIGTYPE_p_FMOD_STUDIO_EVENTINSTANCE eventinstance, float[] pitch) {
    return FMOD_RESULT.swigToEnum(fmodJNI.FMOD_Studio_EventInstance_GetPitch(SWIGTYPE_p_FMOD_STUDIO_EVENTINSTANCE.getCPtr(eventinstance), pitch));
  }
  ...
  public static FMOD_RESULT FMOD_Studio_EventInstance_GetPlaybackState(SWIGTYPE_p_FMOD_STUDIO_EVENTINSTANCE eventinstance, SWIGTYPE_p_FMOD_STUDIO_PLAYBACK_STATE state) {
    return FMOD_RESULT.swigToEnum(fmodJNI.FMOD_Studio_EventInstance_GetPlaybackState(SWIGTYPE_p_FMOD_STUDIO_EVENTINSTANCE.getCPtr(eventinstance), SWIGTYPE_p_FMOD_STUDIO_PLAYBACK_STATE.getCPtr(state)));
  }
  ...
  public static FMOD_RESULT FMOD_Studio_EventInstance_GetCue(SWIGTYPE_p_FMOD_STUDIO_EVENTINSTANCE eventinstance, String name, SWIGTYPE_p_p_FMOD_STUDIO_CUEINSTANCE cue) {
    return FMOD_RESULT.swigToEnum(fmodJNI.FMOD_Studio_EventInstance_GetCue(SWIGTYPE_p_FMOD_STUDIO_EVENTINSTANCE.getCPtr(eventinstance), name, SWIGTYPE_p_p_FMOD_STUDIO_CUEINSTANCE.getCPtr(cue)));
  }

  public static FMOD_RESULT FMOD_Studio_EventInstance_GetCueByIndex(SWIGTYPE_p_FMOD_STUDIO_EVENTINSTANCE eventinstance, int index, SWIGTYPE_p_p_FMOD_STUDIO_CUEINSTANCE cue) {
    return FMOD_RESULT.swigToEnum(fmodJNI.FMOD_Studio_EventInstance_GetCueByIndex(SWIGTYPE_p_FMOD_STUDIO_EVENTINSTANCE.getCPtr(eventinstance), index, SWIGTYPE_p_p_FMOD_STUDIO_CUEINSTANCE.getCPtr(cue)));
  }

  public static FMOD_RESULT FMOD_Studio_EventInstance_GetCueCount(SWIGTYPE_p_FMOD_STUDIO_EVENTINSTANCE eventinstance, int[] count) {
    return FMOD_RESULT.swigToEnum(fmodJNI.FMOD_Studio_EventInstance_GetCueCount(SWIGTYPE_p_FMOD_STUDIO_EVENTINSTANCE.getCPtr(eventinstance), count));
  }
  ...
  public static int FMOD_Studio_CueInstance_IsValid(SWIGTYPE_p_FMOD_STUDIO_CUEINSTANCE cueinstance) {
    return fmodJNI.FMOD_Studio_CueInstance_IsValid(SWIGTYPE_p_FMOD_STUDIO_CUEINSTANCE.getCPtr(cueinstance));
  }

  public static FMOD_RESULT FMOD_Studio_CueInstance_Trigger(SWIGTYPE_p_FMOD_STUDIO_CUEINSTANCE cueinstance) {
    return FMOD_RESULT.swigToEnum(fmodJNI.FMOD_Studio_CueInstance_Trigger(SWIGTYPE_p_FMOD_STUDIO_CUEINSTANCE.getCPtr(cueinstance)));
  }
  ...
  public static FMOD_RESULT FMOD_Studio_Bus_GetFaderLevel(SWIGTYPE_p_FMOD_STUDIO_BUS bus, float[] level) {
    return FMOD_RESULT.swigToEnum(fmodJNI.FMOD_Studio_Bus_GetFaderLevel(SWIGTYPE_p_FMOD_STUDIO_BUS.getCPtr(bus), level));
  }

  public static FMOD_RESULT FMOD_Studio_Bus_SetFaderLevel(SWIGTYPE_p_FMOD_STUDIO_BUS bus, float level) {
    return FMOD_RESULT.swigToEnum(fmodJNI.FMOD_Studio_Bus_SetFaderLevel(SWIGTYPE_p_FMOD_STUDIO_BUS.getCPtr(bus), level));
  }
  ...
  public static FMOD_RESULT FMOD_Studio_VCA_GetFaderLevel(SWIGTYPE_p_FMOD_STUDIO_VCA vca, float[] level) {
    return FMOD_RESULT.swigToEnum(fmodJNI.FMOD_Studio_VCA_GetFaderLevel(SWIGTYPE_p_FMOD_STUDIO_VCA.getCPtr(vca), level));
  }

  public static FMOD_RESULT FMOD_Studio_VCA_SetFaderLevel(SWIGTYPE_p_FMOD_STUDIO_VCA vca, float level) {
    return FMOD_RESULT.swigToEnum(fmodJNI.FMOD_Studio_VCA_SetFaderLevel(SWIGTYPE_p_FMOD_STUDIO_VCA.getCPtr(vca), level));
  }
  ...
  public static FMOD_RESULT FMOD_Studio_CommandReplay_GetPlaybackState(SWIGTYPE_p_FMOD_STUDIO_COMMANDREPLAY replay, SWIGTYPE_p_FMOD_STUDIO_PLAYBACK_STATE state) {
    return FMOD_RESULT.swigToEnum(fmodJNI.FMOD_Studio_CommandReplay_GetPlaybackState(SWIGTYPE_p_FMOD_STUDIO_COMMANDREPLAY.getCPtr(replay), SWIGTYPE_p_FMOD_STUDIO_PLAYBACK_STATE.getCPtr(state)));
  }
  ...
  public static FMOD_RESULT FMOD_Studio_CommandReplay_SetLoadBankCallback(SWIGTYPE_p_FMOD_STUDIO_COMMANDREPLAY replay, SWIGTYPE_p_f_p_struct_FMOD_STUDIO_COMMANDREPLAY_int_p_q_const__FMOD_GUID_p_q_const__char_unsigned_int_p_p_struct_FMOD_STUDIO_BANK_p_void__FMOD_RESULT callback) {
    return FMOD_RESULT.swigToEnum(fmodJNI.FMOD_Studio_CommandReplay_SetLoadBankCallback(SWIGTYPE_p_FMOD_STUDIO_COMMANDREPLAY.getCPtr(replay), SWIGTYPE_p_f_p_struct_FMOD_STUDIO_COMMANDREPLAY_int_p_q_const__FMOD_GUID_p_q_const__char_unsigned_int_p_p_struct_FMOD_STUDIO_BANK_p_void__FMOD_RESULT.getCPtr(callback)));
  }
  ...
  public static SWIGTYPE_p_p_FMOD_STUDIO_CUEINSTANCE new_FMOD_STUDIO_CUEINSTANCE_p_p() {
    long cPtr = fmodJNI.new_FMOD_STUDIO_CUEINSTANCE_p_p();
    return (cPtr == 0) ? null : new SWIGTYPE_p_p_FMOD_STUDIO_CUEINSTANCE(cPtr, false);
  }

  public static SWIGTYPE_p_p_FMOD_STUDIO_CUEINSTANCE copy_FMOD_STUDIO_CUEINSTANCE_p_p(SWIGTYPE_p_FMOD_STUDIO_CUEINSTANCE value) {
    long cPtr = fmodJNI.copy_FMOD_STUDIO_CUEINSTANCE_p_p(SWIGTYPE_p_FMOD_STUDIO_CUEINSTANCE.getCPtr(value));
    return (cPtr == 0) ? null : new SWIGTYPE_p_p_FMOD_STUDIO_CUEINSTANCE(cPtr, false);
  }

  public static void delete_FMOD_STUDIO_CUEINSTANCE_p_p(SWIGTYPE_p_p_FMOD_STUDIO_CUEINSTANCE obj) {
    fmodJNI.delete_FMOD_STUDIO_CUEINSTANCE_p_p(SWIGTYPE_p_p_FMOD_STUDIO_CUEINSTANCE.getCPtr(obj));
  }

  public static void FMOD_STUDIO_CUEINSTANCE_p_p_assign(SWIGTYPE_p_p_FMOD_STUDIO_CUEINSTANCE obj, SWIGTYPE_p_FMOD_STUDIO_CUEINSTANCE value) {
    fmodJNI.FMOD_STUDIO_CUEINSTANCE_p_p_assign(SWIGTYPE_p_p_FMOD_STUDIO_CUEINSTANCE.getCPtr(obj), SWIGTYPE_p_FMOD_STUDIO_CUEINSTANCE.getCPtr(value));
  }

  public static SWIGTYPE_p_FMOD_STUDIO_CUEINSTANCE FMOD_STUDIO_CUEINSTANCE_p_p_value(SWIGTYPE_p_p_FMOD_STUDIO_CUEINSTANCE obj) {
    long cPtr = fmodJNI.FMOD_STUDIO_CUEINSTANCE_p_p_value(SWIGTYPE_p_p_FMOD_STUDIO_CUEINSTANCE.getCPtr(obj));
    return (cPtr == 0) ? null : new SWIGTYPE_p_FMOD_STUDIO_CUEINSTANCE(cPtr, false);
  }
